...
<div align="center">
    ...
    <a href="#">
        <img src="https://img.shields.io/badge/version-0.8.1-white" alt="!version">
    </a>
</div>
...
To install `wise2mbh-0.8.1` you will need to have `git` installed. If you don't have it, you can install it in **Linux** with the following command:

    sudo apt install git

To install `wise2mbh-0.8.1`, use the following command:
...
- WISE2MBH last version: **stable-0.8.1**
