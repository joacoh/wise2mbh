...
- All lookup tables were produced by T.H.J and come originally from the publication: [https://iopscience.iop.org/article/10.3847/1538-4357/acb68f/meta][A New Wide-field Infrared Survey Explorer Calibration of Stellar Mass]. These can be found in the kcorrections folder. If you just want to use that tables, please consider referencing that publication instead of WISE2MBH.